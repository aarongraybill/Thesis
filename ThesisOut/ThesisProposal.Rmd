...
In order to simulate the possible conditions, I generate sample values for each of the variables in \ref{eq:two_period_choices}. Absent a more informed prior, I sample each variable in a reasonable range of values. I summarize these ranges below:

+---------------------------------------------+----------------------+------------------------+------------------------+
| Variable                                    | Symbol               | Minimal Possible Value | Maximal Possible Value |
+=============================================+======================+========================+========================+
| Streams per capita, high quality            | $n(\overline z)$     | $0$                    |                        |
+---------------------------------------------+----------------------+------------------------+------------------------+
| Streams per capita, low quality             | $n(\underline z)$    | $0$                    |                        |
+---------------------------------------------+----------------------+------------------------+------------------------+
| Starting audience                           | $A_0$                | $0$                    |                        |
+---------------------------------------------+----------------------+------------------------+------------------------+
| Discount factor                             | $\beta$              | $0$                    |                        |
+---------------------------------------------+----------------------+------------------------+------------------------+
| Audience depreciation rate                  | $\delta$             | $0$                    |                        |
+---------------------------------------------+----------------------+------------------------+------------------------+
| Expected impressions per song, high quality | $I(n(\overline z))$  | $0$                    |                        |
+---------------------------------------------+----------------------+------------------------+------------------------+
| Expected impression per song, low quality   | $I(n(\underline z))$ | $0$                    |                        |
+---------------------------------------------+----------------------+------------------------+------------------------+
| Initial expected impressions                | $I_0$                | $0$                    |                        |
+---------------------------------------------+----------------------+------------------------+------------------------+

: Sample range for simulated parameter values
